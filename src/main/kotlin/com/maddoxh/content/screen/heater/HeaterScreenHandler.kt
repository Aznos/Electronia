...
class HeaterScreenHandler(syncID: Int, playerInventory: PlayerInventory?, be: BlockEntity?) :
    ScreenHandler(ModScreenHandlers.HEATER_SCREEN_HANDLER, syncID) {
    private val inventory: Inventory
    val blockEntity = be as HeaterBlockEntity
